...
parameters = {'n_estimators':[200, 500], 'max_depth':[30, 50, 60]}
rf = RandomForestRegressor()
cross = GridSearchCV(rf, parameters).fit(X,y)
...
#        pipeline_model, parameters, scoring='neg_mean_absolute_error', cv=5, error_score='raise', n_jobs=-1, verbose=10, n_iter=100, random_state=42)
#    
...
with open('rf_tuning.txt', 'w') as f:
